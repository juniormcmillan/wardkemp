 ...
 * ==============================================================================
 * 
 * @version $Id: access.class.php,v 0.91 2007/11/09 10:54:32 $
		...
		if ( is_array($settings) ){
			foreach ( $settings as $k => $v ){
				if ( property_exists($this, $k) ) 
					...
					die('Property '.$k.' does not exists');
			}
		}
