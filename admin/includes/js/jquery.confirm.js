    ...
    $.fn.confirm = function (options, option2) {        
        ...
        $(this).each(function () {
            ...
            $this.on('click', function (e) {
                ...
                if ($this.attr('data-confirm-button'))
                    jcOption['confirmButton'] = $this.attr('data-confirm-button');
                if ($this.attr('data-confirm-button-class'))
                    jcOption['confirmButtonClass'] = $this.attr('data-confirm-button-class');
                if ($this.attr('data-confirm-button'))
                    jcOption['cancelButton'] = $this.attr('data-cancel-button');
                if ($this.attr('data-cancel-button-class'))
                    jcOption['cancelButtonClass'] = $this.attr('data-cancel-button-class');
                if ($this.attr('data-icon'))
                    jcOption['icon'] = $this.attr('data-icon');
